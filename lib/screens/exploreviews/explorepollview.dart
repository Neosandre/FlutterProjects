...
class ExplorePollView extends StatefulWidget {
  static const _chars =
  ...
  ExplorePollView(this.post,this.time,this.userWhoVoted,this.likedBy,this.commentCount,this.user/*this.updatefeed*/);


  @override
  State<ExplorePollView> createState() => _ExplorePollViewState();
}

class _ExplorePollViewState extends State<ExplorePollView> {
  ...
  String getRandomString(int length) =>
      String.fromCharCodes(Iterable.generate(length, (_) => ExplorePollView._chars.codeUnitAt(_rnd.nextInt( ExplorePollView._chars.length))));
      ...
      body: ListView(
        children: [
          ...
          Row(children: [
            ...
            widget.post.poll ==true?Text("${usersWhoVoted.length}"
