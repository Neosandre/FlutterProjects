...
class ExploreQuizView extends StatefulWidget {
  static const _chars =
  ...
  final likedBy;
  List commentCount;
  ExploreQuizView(this.user,this.post,this.time, this.answers,
      this.userWhoAnswered, this.likedBy,this.commentCount);

  @override
  State<ExploreQuizView> createState() => _ExploreQuizViewState();
}

class _ExploreQuizViewState extends State<ExploreQuizView> {
  ...
  String getRandomString(int length) =>
      String.fromCharCodes(Iterable.generate(length, (_) => ExploreQuizView._chars.codeUnitAt(_rnd.nextInt( ExploreQuizView._chars.length))));
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          primary: isAnswered && userAnswerCorrect == answerList[1]?
                          Colors.blue: isAnswered && userAnswer == answerList[1]? Colors.red:correctAnswer ==answerList[1]? Colors.blue: Colors.purple,
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),),
