...
class PollView extends StatefulWidget {
  ...
  PollView(this.post,this.time,this.userWhoVoted,this.likedBy,this.commentCount,this.user/*this.updatefeed*/);
...
class _PollViewState extends State<PollView> {
  ...
  String getRandomString(int length) =>
      String.fromCharCodes(Iterable.generate(length, (_) => PollView._chars.codeUnitAt(_rnd.nextInt( PollView._chars.length))));
