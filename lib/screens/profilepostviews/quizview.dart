...
class QuizView extends StatefulWidget {
  ...
  final likedBy;
  List commentCount;
  QuizView(this.user,this.post,this.time, this.answers,
...
class _QuizViewState extends State<QuizView> {
  ...
  String getRandomString(int length) =>
      String.fromCharCodes(Iterable.generate(length, (_) => QuizView._chars.codeUnitAt(_rnd.nextInt( QuizView._chars.length))));
