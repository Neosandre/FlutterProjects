...
class VoteList extends StatelessWidget {
  ...
  final Map<String, int> userWhovoted;
  final opt1;
  final opt2;


  VoteList(this.userWhovoted,this.opt1,this.opt2);
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context,index){
                ...
                for (final mapEntry in userWhovoted.entries) {
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        ListTile(
                          ...
                          Container(
                              width: 200,
                              child: Text('$opt1',style: TextStyle(color:Colors.grey ),overflow: TextOverflow.ellipsis,))
                              :Container(
                              width: 200,
                              child: Text('$opt2',style: TextStyle(color:Colors.grey ),overflow: TextOverflow.ellipsis,)),
                        ),
