...
class AudiopayerMessage extends StatefulWidget {
...
/*
  ...
  AudiopayerMessage(  this.message,
      this.time,
      this.isMe,
      this.key):super(key:ValueKey(key));

  @override
  _AudiopayerMessageState createState() => _AudiopayerMessageState();
}

class _AudiopayerMessageState extends State<AudiopayerMessage> {
  ...
  @override
  void didUpdateWidget(covariant AudiopayerMessage oldWidget) {
      ...
      child: Row(
        ...
        /*    !widget.isMe? Padding(
              ...
              child: CircleAvatar(
                ...
                backgroundImage:
                NetworkImage(widget.message.photo),
...
///########flutter new  error audio###########################

    if (_isPlaying) {
      var res =  _audioPlayer.pause();
      if (res == 1) {
        if(mounted)
          setState(() {
            _isPlaying = false;
      ...
      var res = _isPaused ?  _audioPlayer.resume() :  _audioPlayer
